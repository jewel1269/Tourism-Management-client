...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-gray-600 dark:bg-gray-100 text-gray-100 dark:text-gray-800">
      ...
      <div className="py-6 text-white font-semibold text-sm text-center  dark:text-gray-600">
