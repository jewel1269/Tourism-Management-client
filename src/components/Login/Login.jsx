...
const Login = () => {
  ...
  return (
    ...
    >
      <div
        data-aos="zoom-in"
        className="w-full border-2 shadow-slate-400 lg:mt-10 lg:mb-10 max-w-md lg:ml-[1%] md:ml-[25%] p-8 space-y-3 rounded-xl dark:text-gray-800"
      >
        <h1 className="text-2xl font-bold text-center">Login</h1>
        <form onSubmit={logIn} noValidate="" action="" className="space-y-6">
